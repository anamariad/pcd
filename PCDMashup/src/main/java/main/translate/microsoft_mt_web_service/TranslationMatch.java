...
public class TranslationMatch {
    ...
    @XmlElementRef(name = "MatchedOriginalText", namespace = "http://schemas.datacontract.org/2004/07/Microsoft.MT.Web.Service.V2", type = JAXBElement.class, required = false)
    ...
    public void setMatchedOriginalText(JAXBElement<String> value) {
        this.matchedOriginalText = value;
    }
