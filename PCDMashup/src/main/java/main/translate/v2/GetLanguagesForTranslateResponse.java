...
public class GetLanguagesForTranslateResponse {
    ...
    @XmlElementRef(name = "GetLanguagesForTranslateResult", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    ...
    public void setGetLanguagesForTranslateResult(JAXBElement<ArrayOfstring> value) {
        this.getLanguagesForTranslateResult = value;
    }
