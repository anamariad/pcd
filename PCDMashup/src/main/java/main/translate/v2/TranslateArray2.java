...
@XmlRootElement(name = "TranslateArray2")
public class TranslateArray2 {
    ...
    @XmlElementRef(name = "texts", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
