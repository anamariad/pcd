...
public class GetLanguageNamesResponse {
    ...
    @XmlElementRef(name = "GetLanguageNamesResult", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    ...
    public void setGetLanguageNamesResult(JAXBElement<ArrayOfstring> value) {
        this.getLanguageNamesResult = value;
    }
