...
public class TranslateArrayResponse {
    ...
    @XmlElementRef(name = "TranslateArrayResult", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    ...
    public void setTranslateArrayResult(JAXBElement<ArrayOfTranslateArrayResponse> value) {
        this.translateArrayResult = value;
    }
