...
public class GetLanguageNames {
    ...
    @XmlElementRef(name = "locale", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    protected JAXBElement<String> locale;
    @XmlElementRef(name = "languageCodes", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
