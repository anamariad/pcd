...
public class BreakSentencesResponse {
    ...
    @XmlElementRef(name = "BreakSentencesResult", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    ...
    public void setBreakSentencesResult(JAXBElement<ArrayOfint> value) {
        this.breakSentencesResult = value;
    }
