...
public class GetLanguagesForSpeakResponse {
    ...
    @XmlElementRef(name = "GetLanguagesForSpeakResult", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    ...
    public void setGetLanguagesForSpeakResult(JAXBElement<ArrayOfstring> value) {
        this.getLanguagesForSpeakResult = value;
    }
