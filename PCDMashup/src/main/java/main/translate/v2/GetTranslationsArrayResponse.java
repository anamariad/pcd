...
public class GetTranslationsArrayResponse {
    ...
    @XmlElementRef(name = "GetTranslationsArrayResult", namespace = "http://api.microsofttranslator.com/V2", type = JAXBElement.class, required = false)
    ...
    public void setGetTranslationsArrayResult(JAXBElement<ArrayOfGetTranslationsResponse> value) {
        this.getTranslationsArrayResult = value;
    }
