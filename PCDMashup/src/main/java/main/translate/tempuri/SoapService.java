 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://api.microsofttranslator.com/V2/Soap.svc")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://tempuri.org/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://api.microsofttranslator.com/V2/Soap.svc");
